...
# private job network = 175.20.0.0/16
# public job network = 175.21.0.0/16
# [all networks] Rewrite traffic coming from containers to masquerade as the host
iptables --table nat --append POSTROUTING --source 175.20.0.0/15 --jump MASQUERADE

# [public]
# Block public traffic to the metadata server
iptables --append FORWARD --source 175.21.0.0/16 --destination 169.254.169.254 --jump DROP
