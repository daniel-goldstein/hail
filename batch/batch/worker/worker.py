...
class Worker:
    ...
    async def create_job_1(self, batch_id, job_id, start_job_id, token, addtl_spec, gsa_key, user, format_version):
    ...
    async def create_job(self, request):
        ...
        self.task_manager.ensure_future(
            self.create_job_1(batch_id, job_id, start_job_id, token, addtl_spec, gsa_key, user, format_version)
        )
