...
g_std.write(
    'gs://hail-datasets-hail-data/1000_Genomes_phase3_European_autosomes_maf_gt_001_standardized.bm', overwrite=True
)
...
hl.experimental.write_expression(
    metadata,
    'gs://hail-datasets-hail-data/1000_Genomes_phase3_European_autosomes_maf_gt_001_standardized.metadata.he',
    overwrite=True,
)
