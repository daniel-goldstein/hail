...
ht_exons = hl.import_table(
    'gs://hail-datasets/raw-data/gtex/v7/reference/gencode.v19.genes.v7.patched_contigs.exons.txt',
    types={'start_pos': hl.tint, 'end_pos': hl.tint},
    missing='.',
    min_partitions=12,
)
ht_exons = ht_exons.annotate(
    interval=hl.interval(
        hl.locus(ht_exons.chr, ht_exons.start_pos, 'GRCh37'), hl.locus(ht_exons.chr, ht_exons.end_pos + 1, 'GRCh37')
    )
)
...
mt = hl.import_matrix_table(
    'gs://hail-datasets/raw-data/gtex/v7/rna-seq/processed/GTEx_Analysis_2016-01-15_v7_RNASeQCv1.1.8_exon_reads.tsv.bgz',
