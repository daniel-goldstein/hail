...
mt = hl.read_matrix_table('gs://hail-datasets/hail-data/gtex_v7_gene_tpm.GRCh37.mt')
...
mt.describe()
mt.write('gs://hail-datasets/hail-data/gtex_v7_gene_tpm.GRCh38.liftover.mt', overwrite=True)
