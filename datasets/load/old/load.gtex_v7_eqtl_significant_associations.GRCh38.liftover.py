...
mt = hl.read_matrix_table('gs://hail-datasets/hail-data/gtex_v7_eqtl_significant_associations.GRCh37.mt')
mt.describe()
...
mt.describe()
mt.write('gs://hail-datasets/hail-data/gtex_v7_eqtl_significant_associations.GRCh38.liftover.mt', overwrite=True)
