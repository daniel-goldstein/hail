...
ht_samples = ht_samples.rename({'f0': 's', 'f1': 'population', 'f2': 'super_population'})
...
ht_samples = ht_samples.annotate_globals(
    metadata=hl.struct(name='1000_Genomes_phase3_samples', n_rows=n_rows, n_partitions=n_partitions)
)
