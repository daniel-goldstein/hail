...
mt = hl.import_vcf(
    'gs://hail-datasets-raw-data/1000_Genomes/1000_Genomes_phase3_chrX_GRCh38.vcf.bgz',
...
mt_split.write('gs://hail-datasets-hail-data/1000_Genomes_phase3_chrX.GRCh38.mt', overwrite=True)

mt = hl.read_matrix_table('gs://hail-datasets-hail-data/1000_Genomes_phase3_chrX.GRCh38.mt')
mt.describe()
print(mt.count())
