...
np.savetxt(
    '/tmp/Human_Cell_Atlas_cord_blood_immunocytes.counts.tsv',
...
np.savetxt(
    '/tmp/Human_Cell_Atlas_cord_blood_immunocytes.barcodes.tsv',
...
np.savetxt(
    '/tmp/Human_Cell_Atlas_cord_blood_immunocytes.genes.tsv',
...
call(
    [
        'gsutil',
        'cp',
        '/tmp/Human_Cell_Atlas_cord_blood_immunocytes.counts.tsv.gz',
...
call(
    [
        'gsutil',
        'cp',
        '/tmp/Human_Cell_Atlas_cord_blood_immunocytes.barcodes.tsv.gz',
...
call(
    [
        'gsutil',
        'cp',
        '/tmp/Human_Cell_Atlas_cord_blood_immunocytes.genes.tsv.gz',
