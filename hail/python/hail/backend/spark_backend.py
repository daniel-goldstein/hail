...
class SparkBackend(Py4JBackend):
    ...
    def parse_vcf_metadata(self, path):
        return orjson.loads(self._jhc.pyParseVCFMetadataJSON(self.fs._jfs, path))
    ...
    def read_multiple_matrix_tables(self, paths: 'List[str]', intervals: 'List[hl.Interval]', intervals_type):
        ...
        results = self._jhc.backend().pyReadMultipleMatrixTables(orjson.dumps(json_repr).decode('utf-8'))
